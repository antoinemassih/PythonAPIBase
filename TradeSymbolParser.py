...
def ETTradeSymbolParser(symbol):
    ...
    symbol_data = {'ticker': symbol_array[0]}
    ...
    if len(symbol_array)>2:
        ...
        symbol_data['optionExpiry'] = str(symbol_array[2]) +'/'+ str(the_month) +'/'+symbol_array[3].replace("'","20")
        symbol_data['trade_group'] = symbol_data['ticker']+symbol_data['optionType']+str(symbol_data['optionStrike'])+symbol_data['optionExpiry']
    else:
        return symbol_data
